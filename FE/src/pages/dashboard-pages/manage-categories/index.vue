<template>
    <div class="card mb-4">
        <div class="card-header pb-0 d-flex justify-content-between">
            ...
            <button class="btn" data-bs-toggle="modal" data-bs-target="#categoriesModal">Tạo mới</button>
        </div>
        <div class="card">
            <div>
                            ...
                            <td class="align-middle text-center dropdown" @click="view(value)">
                                ...
                                <ul class="dropdown-menu dropdown-menu-vps"
                                    ...
                                    <li class="cursor-pointer">
                                        <div class="dropdown-item" data-bs-toggle="modal" data-bs-target="#categoriesEditModal">Update</div>
                                    </li>
                                    <li class="cursor-pointer">
    ...
    methods: {
        ...
        async remove(userId) {
            swal({
                ...
                .then(async next => {
                    if (next) {
                        await instance.delete(`categories/${userId}`);
        ...
        async getPaginate() {
            const self = this;
            const baseUrl = `categories/${self.pageIndex}/${self.limit}`;
